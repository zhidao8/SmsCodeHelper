...
//    // 正在修改中的 ListView DbSms 在 ListView 中的位置
...
//
//        // 初始化编辑面板
////        etSms = view.findViewById(R.id.et_sms)
////        etCode = view.findViewById(R.id.et_code)
////        tvTips = view.findViewById(R.id.tv_tips)
////        addRuleLayoutBg = view.findViewById(R.id.add_rule_layout_bg)
////        addRuleLayout = view.findViewById(R.id.add_rule_layout)
...
//        recyclerView.onItemLongClickListener = listener
//
...
//                            if (successful) {
//                                refreshData()
//                                ToastUtil.showSingletonToast(R.string.import_success, Toast.LENGTH_SHORT)
//                            } else {
//                                ToastUtil.showSingletonToast(R.string.import_fail, Toast.LENGTH_SHORT)
//                            }
//                        } else {
//                            ToastUtil.showSingletonToast(R.string.file_not_choose, Toast.LENGTH_SHORT)
//                        }
//                    }
//                    .create()
//                    .show()
...
//
//        /**
//         * 修改 position 位置的 DbSms
//         *
//         * @param position DbSms 在 ListView 中的位置
//         * @param newBean  新的 DbSms
//         */
...
//         * 统一设置所有 DbSms 的选取状态
//         *
//         * @param checked true 则设置所有 DbSms 为选取状态，false 则设置所有 DbSms 为未选取状态
//         */
