...
// */
//
//class CodeSmsClearFragment : Fragment(), View.OnClickListener, ActionMode.Callback,
//    AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, OnBackPressedFragment {
//
...
//    ): View? {
//        return inflater.inflate(R.layout.fragment_code_sms_clear, container, false)
//    }
//
...
//        viewSmsLayoutBg = view.findViewById(R.id.view_sms_layout_bg)
//        viewSmsLayoutBg.setOnClickListener(this)
//        viewSmsLayout = view.findViewById(R.id.view_sms_layout)
//
...
//        ReadDataTask().execute(context, progressBar, adapter)
//    }
//
...
//                val view = LayoutInflater.from(parent.context).inflate(R.layout.code_clear_list_item, parent, false)
...
//            val codeSms = wrappedItem.item.codeSms
